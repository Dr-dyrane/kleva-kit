			...
			<Link
				...
				className={`block py-2 md:py-0 px-3 my-1 md:my-0 md:p-0 ${
					location.pathname === to
						? "bg-primary text-contrast-dark font-medium rounded-xl md:bg-transparent md:text-secondary"
						: "rounded-xl font-normal hover:text-white md:hover:text-secondary hover:bg-primary/75 md:hover:bg-transparent dark:md:hover:text-secondary dark:hover:text-contrast-dark md:dark:hover:bg-transparent dark:border-slate-700"
				}`}
