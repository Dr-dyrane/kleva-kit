	...
	return (
		<footer className="border-t-[1px] text-contrast/85 dark:text-contrast-dark/50 border-slate-300 dark:border-background/15">
			<div className="w-full mx-auto max-w-screen-xl p-4 flex flex-col justify-between">
				...
				{/* Newsletter Signup */}
				<div className="mt-4 text-sm w-full lg:flex lg:justify-between lg:max-w-md lg:items-center">
					...
					<form className="flex flex-col sm:flex-row mt-2 lg:mt-0">
						...
						<button
							type="submit"
							className="p-2 bg-primary text-white rounded-lg hover:bg-opacity-80 focus:outline-none focus:bg-opacity-80"
						>
							Subscribe
						</button>
					</form>
