		...
		>
			...
			<div className="relative z-10 text-center space-y-14">
				...
				>
					<a
						href="/login"
						className="relative inline-block px-8 py-4 text-lg font-semibold text-white bg-secondary rounded-lg transition duration-300 ease-in-out transform hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-opacity-50"
					>
					...
					<a
						href="#"
						className="relative inline-block px-8 py-4 text-lg font-semibold text-secondary bg-white rounded-lg transition duration-300 ease-in-out transform hover:bg-gray-200 hover:text-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark focus:ring-offset-2 focus:ring-opacity-50"
					>
