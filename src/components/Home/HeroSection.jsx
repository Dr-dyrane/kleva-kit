...
const HeroSection = () => {
	return (
		<motion.section
			...
			className="relative p-8 flex flex-col md:flex-row items-center justify-between min-h-screen bg-hero-pattern bg-cover bg-center"
		>
			<div className="absolute inset-0 bg-gradient-primary-secondary-dark opacity-50"></div>
			<div className="relative z-10 text-center flex flex-col justify-center md:justify-between space-y-10 md:space-y-16 lg:space-y-20 max-w-xl lg:max-w-2xl xl:max-w-3xl 2xl:max-w-5xl min-h-full flex-grow">
				<motion.h1
					initial={{ y: -50, opacity: 0 }}
					animate={{ y: 0, opacity: 1 }}
					transition={{ duration: 1 }}
					className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-contrast-dark text-left"
				>
				...
				<motion.p
					...
					className="mt-4 text-contrast-dark text-left leading-7 sm:leading-8 md:leading-9 lg:leading-10 xl:leading-loose 2xl:leading-relaxed md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl"
				>
